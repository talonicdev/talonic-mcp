...
**Last audit:** 2026-09-22 (full re-audit: 36 tools / 36 widgets, the Specs/Run/Ask and decision-task tool sets, 0.1.80 live on npm/Registry/hosted-endpoint, directory status, changelog-anchored release history, open items). Earlier: 2026-06-03, 2026-05-19. **Audited by:** Claude (assisting Hamlet). **Scope:** sync versions, follow-ups, and resolved items across `@talonic/mcp`, `@talonic/node`, website, and the official MCP Registry.
...
| --- | --- |
| Repo | `main` = `origin/main` = v0.1.80 (published 2026-09-24; 0.1.79 on 2026-09-22); shipped in that release: the 2026-09-22 housekeeping/widget-parity/Specs-Run-Ask program. A push is a release and waits for Hamlet's go. |
| package.json / server.json version | 0.1.80 (CI auto-bumps on the next publishing push) |
| npm published version | 0.1.80 (2026-09-24, trusted publishing; 0.1.79 on 2026-09-22) |
| Hosted endpoint | `https://mcp.talonic.com` serving 0.1.80; `/health` ok |
...
| Item | State (2026-09-22) |
| --- | --- |
| Listing | `io.github.talonicdev/talonic-mcp`, isLatest **0.1.80** (published 2026-09-24), status active; auto-tracked by `mcp-publisher` in `publish.yml` |

...
Since then the server has grown from 8 to 36 public tools — all with titles and read-only/destructive/open-world hints, every tool functionally tested — with OAuth 2.1, public documentation (https://talonic.com/docs/mcp), a privacy policy (https://talonic.com/privacy) and a security disclosure channel (safety@talonic.ai). It is already live in the ChatGPT App Directory and the official MCP Registry.

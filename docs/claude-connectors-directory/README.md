...
- [ ] Release 0.1.79 is live (`curl -s https://mcp.talonic.com/health` shows the version). As of 2026-09-22 the live version is still 0.1.78 (local `main`, unpublished; publish 0.1.79 first) — so the portal's automatic scan sees all 36 tools, then work through `resubmission-2026-09.md`.

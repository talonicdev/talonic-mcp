...
export const sections: RawSection[] = [
  {
    ...
    description: 'Environment variables for configuring the Talonic MCP server: API key and optional base URL override.',
    content: [
    ...
    faq: [
      { question: 'What environment variables does the Talonic MCP server need?', answer: 'TALONIC_API_KEY (required, starts with tlnc_) and optionally TALONIC_BASE_URL to override the API endpoint.' },
    ],
